...
<div class="span7" style="margin-left: 0">
	<form action="<?php echo current_url(); ?>" method="get" >
		<div class="span4" style="margin-left: 0">
			<label>Período <i class="icon-info-sign " title="Lançamentos com vencimento no período."></i></label>
		...
		<div class="span4">
			<label>Situação <i class="icon-info-sign " title="Lançamentos com situação específica ou todos."></i></label>
...
<div id="modalReceita" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    ...
    <h3 id="myModalLabel">CloudsBox - Adicionar Receita</h3>
  </div>
  <div class="modal-body">
    	...
    	<div class="span12" style="margin-left: 0"> 
	    	...
	    	<div class="span4" >
	    		...
	    		<input class="span12" id="vencimento" type="text" name="vencimento" value="<?php echo date('d/m/Y'); ?>"/>
	    	</div>
    	...
    	<div class="span12" style="margin-left: 0"> 
    		...
    		<div id="divRecebimento" class="span8" style=" display: block">
	    		<div class="span6">
	    			<label for="recebimento">Data Recebimento</label>
		    		<input class="span12" id="recebimento" type="text" name="recebimento" value="<?php echo date('d/m/Y'); ?>"/>	
	    		</div>
	    		<div class="span6">
...
<div id="modalDespesa" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="myModalLabel">CloudsBox - Adicionar Despesa</h3>
  </div>
  <div class="modal-body">
  		<div class="span12 alert alert-info" style="margin-left: 0"> Obrigatório o preenchimento dos campos com asterisco.</div>
    	<div class="span12" style="margin-left: 0"> 
    	...
    	<div class="span12" style="margin-left: 0"> 
	    	...
	    	<div class="span4" >
	    		<label for="vencimento">Data Vencimento*</label>
	    		<input class="span12"  type="text" name="vencimento" value="<?php echo date('d/m/Y'); ?>"/>
	    	</div>
    	...
    	<div class="span12" style="margin-left: 0"> 
    		<div class="span4" style="margin-left: 0">
	    		...
	    		&nbsp &nbsp &nbsp &nbsp<input  id="pago" type="checkbox" name="pago" value="1"  checked/>	
    		</div>
    		<div id="divPagamento" class="span8" style=" display: block">
	    		<div class="span6">
	    			<label for="pagamento">Data Pagamento</label>
		    		<input class="span12" id="pagamento" type="text" name="pagamento" value="<?php echo date('d/m/Y'); ?>"/>	
	    		</div>
...
<div id="modalEditar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="myModalLabel">CloudsBox - Editar Lançamento</h3>
  </div>
  <div class="modal-body">
      <div class="span12 alert alert-info" style="margin-left: 0"> Obrigatório o preenchimento dos campos com asterisco.</div>
      <div class="span12" style="margin-left: 0"> 
      ...
      <div class="span12" style="margin-left: 0"> 
        ...
        <div class="span4" >
          <label for="vencimento">Data Vencimento*</label>
          <input class="span12"  type="text" name="vencimento" id="vencimentoEditar" value="<?php echo date('d/m/Y'); ?>"/>
        </div>
        <div class="span4">
      ...
      <div class="span12" style="margin-left: 0"> 
        <div class="span4" style="margin-left: 0">
          <label for="pago">Foi Pago?</label>
          &nbsp &nbsp &nbsp &nbsp<input  id="pagoEditar" type="checkbox" name="pago" value="1" checked/> 
        </div>
        <div id="divPagamentoEditar" class="span8" style=" display: block">
          <div class="span6">
            <label for="pagamento">Data Pagamento</label>
            <input class="span12" id="pagamentoEditar" type="text" name="pagamento" value="<?php echo date('d/m/Y'); ?>"/>  
          </div>
...
<div id="modalExcluir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="myModalLabel">CloudsBox - Excluir Lançamento</h3>
  </div>
  <div class="modal-body">
