...
<html lang="en">
<head>
<title>Cloudsbox</title>

<meta charset="UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1 initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
<meta name="apple-mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-status-bar-style" content="#2E363F">
...
<link rel="shortcut icon" href="<?php echo base_url(); ?>assets/img/favicon/favicon-16x16.png">
...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    <li class=""><a title="" href="#" id="btn-toggle"><i class="icon-list"></i></a></li>
    <li class=""><a title="" href="<?php echo site_url();?>/cloudsbox/minhaConta"><i class="icon icon-star"></i> <span class="text">Minha Conta</span></a></li>
    <li class=""><a title="" href="<?php echo site_url();?>/mine"><i class="icon icon-eye-open"></i> <span class="text">Área do Cliente</span></a></li>
    <li class=""><a title="" href="<?php echo site_url();?>/cloudsbox/sair"><i class="icon icon-share-alt"></i> <span class="text">Sair do Sistema</span></a></li>
  </ul>
...
<!--start-top-serch-->
<div id="search">
  <form action="<?php echo base_url()?>index.php/cloudsbox/pesquisar">
        ...
        <li class="submenu <?php if(isset($menuConfiguracoes)){echo 'active open';};?>">
          ...
          <ul>
            ...
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'cEmitente')){ ?>
                <li><a href="<?php echo base_url()?>index.php/cloudsbox/emitente">Emitente</a></li>
            <?php } ?>
            ...
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'cBackup')){ ?>
                <li><a href="<?php echo base_url()?>index.php/cloudsbox/backup">Backup</a></li>
            <?php } ?>
...
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> <p><?php echo date('Y'); ?> &copy; Cloudsbox - todos os direitos reservados. </p></div>
</div>
<!--end-Footer-part-->
