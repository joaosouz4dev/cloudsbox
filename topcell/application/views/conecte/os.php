            ...
            <div class="widget-content nopadding">
                ...
                <table class="table table-bordered ">
                    ...
                    <?php foreach ($results as $r) {
                        ...
                        echo '<td><a href="' . base_url() . 'index.php/mine/visualizarOs/' . $r->idOs . '" class="btn " title="Visualizar e Imprimir"><i class="icon-eye-open"></i></a>
                                  <a href="' . base_url() . 'index.php/mine/imprimirOs/' . $r->idOs . '" target="_blank" class="btn btn-inverse " title="Imprimir"><i class="icon-print"></i></a>
                                  <a href="' . base_url() . 'index.php/mine/detalhesOs/' . $r->idOs . '" class="btn btn-info " title="Ver mais detalhes"><i class="icon-list"></i></a>  
                              </td>';
                        echo '</tr>';
                    } ?>
                    <tr>
